...
function add_meta_boxes_fitcasestudy() {
	...
	add_meta_box(
	        'fitcase-client-current-measure',
            __( 'Current Measurements', 'fitcasestudy' ),
            'meta_box_client_current_measure_callback',
            'fitcasestudy',
            'side',
            'high'
    );
...
function meta_box_client_current_measure_callback( $post ) {
    echo 'Hi! I\'m a placeholder!';
}

	...
	<p>
        ...
        <?php
            ...
            if ( isset( $fitcase_post_meta['fitcase_client_height'] ) ) {
                ...
                error_log( '[VAR] $fitcase_height =' . $fitcase_height );
	            preg_match_all( '/[^A-Za-z\s]+/', $fitcase_height, $fitcase_matches_results );

	            error_log( '[ARRAY] $fitcase_matches_results' . print_r( $fitcase_matches_results, true) );
	            ...
	            error_log( '[ARRAY] $fitcase_matches' . print_r( $fitcase_matches, true) );
            }
        ...
        <?php
            ...
            <?php } else { ?>
	            <?php error_log( 'THE UNITS ARE METRIC!') ?>
...
//    }
    ...
    if ( isset( $_POST['fitcase_height_unit'] ) ) {
        ...
        } else if ($fitcase_client_height_unit == 'metric' ){
